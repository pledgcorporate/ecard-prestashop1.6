...
class AdminOrdersController extends AdminOrdersControllerCore
{
    ...
    public function __construct()
    {
		...
		pledg.reference_pledg as ref_pledg';
		...
		LEFT JOIN `'._DB_PREFIX_.'pledg_paiements_confirm` pledg ON pledg.`id_cart` = a.`id_cart`';
    ...
    public function renderView()
    {
        ...
        $sql = 'SELECT reference_pledg FROM '._DB_PREFIX_.'pledg_paiements_confirm WHERE id_cart = %d';
        $order->ref_pledg = Db::getInstance()->getValue(sprintf($sql, $order->id_cart));
